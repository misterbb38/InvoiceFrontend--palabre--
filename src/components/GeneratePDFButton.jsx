...
function GeneratePDFButton({ invoice, currency }) {
  ...
  const generatePDF = () => {
    ...
    // Instead of opening a new tab, use this to trigger the download
    const link = document.createElement('a')
    link.href = url
    link.download = `facture-${invoice._id}.pdf` // Specify the file name
    document.body.appendChild(link)
    link.click()
    document.body.removeChild(link) // Clean up
    URL.revokeObjectURL(url) // Optionally revoke the object URL after download
  }
